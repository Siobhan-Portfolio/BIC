...
****************************************/
var doubleInputLayer = function(input,w, aFunc){
...
var createNewRandMLPdbl = function(input){
  var weights = [Math.random(),
                 Math.random(),
                 Math.random(),
                 Math.random(),
...
var createNewMLPdbl = function(input, weights){
...
var createNewMLPafdbl = function(input, aFunc){
...
var createNewMLPbothdbl = function(input,weights, aFunc){
...
var initializePopulationdbl = function(n){
...
var samplePopulationdbl = function(data,population){
  var size = population.length;
...
var checkMLPdbl = function(input1, input2, expected, sampleNumber, mlp){
